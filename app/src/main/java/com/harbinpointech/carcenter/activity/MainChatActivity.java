...
public class MainChatActivity extends ActionBarActivity {
	...
	protected static final String TAG = "MainChatActivity";
	// 未读消息textview
		...
		public void onInvitationReceived(String groupId, String groupName, String inviter, String reason) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					if (currentTabIndex == 0)
						chatHistoryFragment.refresh();
					if (CommonUtils.getTopActivity(MainChatActivity.this).equals(GroupsActivity.class.getName())) {
...
//		}
	...
	private void showConflictDialog() {
		...
		if (!MainChatActivity.this.isFinishing()) {
			...
			try {
				if (conflictBuilder == null)
					conflictBuilder = new android.app.AlertDialog.Builder(MainChatActivity.this);
