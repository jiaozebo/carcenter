...
import com.harbinpointech.carcenter.activity.AlertDialog;
import com.harbinpointech.carcenter.activity.ChatActivity;
import com.harbinpointech.carcenter.activity.ContextMenu;
import com.harbinpointech.carcenter.activity.ShowBigImage;
import com.harbinpointech.carcenter.activity.ShowNormalFileActivity;
import com.harbinpointech.carcenter.activity.ShowVideoActivity;
import com.harbinpointech.carcenter.task.LoadImageTask;
import com.harbinpointech.carcenter.task.LoadVideoImageTask;
    ...
    private void handleVoiceMessage(final EMMessage message, final ViewHolder holder, final int position, View convertView) {
        ...
        holder.iv.setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                activity.startActivityForResult(
                        (new Intent(activity, ContextMenu.class)).putExtra("position", position).putExtra("type",
                                EMMessage.Type.VOICE.ordinal()), Toast.LENGTH_SHORT);
                return true;
            }
        });
