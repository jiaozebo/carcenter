...
final class CameraConfigurationManager {
	...
	void setDesiredCameraParameters(Camera camera, boolean safeMode) {
		...
		String focusMode = findSettableValue(parameters.getSupportedFocusModes(), // Camera.Parameters.FOCUS_MODE_CONTINUOUS_VIDEO
				// in 4.0+
				Camera.Parameters.FOCUS_MODE_AUTO, "continuous-picture", // Camera.Parameters.FOCUS_MODE_CONTINUOUS_PICTURE
																			// in
																			// 4.0+
				"continuous-video");
